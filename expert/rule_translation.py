...
SUBSTRINGS_EN = (
    ...
    ("Comparer fltmc filters et tester avec les protections Bitdefender adaptees.", "Compare fltmc filters and test with suitable Bitdefender protections."),
    ("La signature SMB obligatoire cote client peut changer la négociation avec certains serveurs.", "Mandatory SMB signing on the client side can change negotiation with some servers."),
    ("Une difference sur les connexions invite peut expliquer qu'un partage public soit accessible depuis un poste et pas l'autre.", "A difference in guest connections may explain why a public share is accessible from one workstation and not another."),
    ...
    ("La machine cible peut publier des partages differemment, ou refuser l'énumération locale.", "The target machine may publish shares differently, or refuse local enumeration."),
